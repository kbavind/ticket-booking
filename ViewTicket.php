			...
			echo "<table width='100%' border = '1' class='w3-table w3-striped-centered'>
				...
				while (($Row = mysqli_fetch_row($QueryResult)))
				{
					echo "<tr class='data'>";
						...
						echo "<td> $Row[6] </td>";
						echo "<td> $Row[7] </td>";
						echo "<td><a href=\"DeleteAdmin.php?Ticketid=$Row[0]\" onclick=\"return confirm('You sure want to delete this data?')\"><button class='delete'><img src='img/delete.png'></button></a></td>";
						echo "<td><a href='UpdateTicket.php?Ticketid=$Row[0]'><button><img src='img/edit.png'></button></a></td>";
					echo "</tr>";	
				}
			echo "</table>";
			echo "</body>";
